...
if opt.csv == 'true' then 
    ...
    if opt.set == 'cvtrain' or opt.set == 'train' then 
        CsvWrite(saveVectors, 'train')
    elseif opt.set == 'cvtest' or opt.set == 'cvvalid' then 
