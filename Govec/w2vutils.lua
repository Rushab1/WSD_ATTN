...
--cmd = torch.CmdLine()
--cmd:option('-bin', 'file.bin')
--opt = cmd:parser(arg)

opt = {
	binfilename ='/media/rushab/993802c3-811d-415b-a814-6a4c61d6b0a8/home/rushab/Documents/Academics_Ubuntu/CS671/CS671_Project/Code/Abstractive-Summarization/word2vec.torch/GoogleNews-vectors-negative300.bin' ,
