...
#######################################################################3
    ...
    Senses2 = []
    for i in range(0,len(Sentences_Split)):
        if Senses_Split[i] in ['HARD2', 'HARD3', 'cord', 'formation', 'phone', 'text', 'division', 'interest1', 'interest2', 'interest3', 'interest4', 'interest5']:
...
#################################################################################
    ...
    for i in range(0,len(Sentences_Split_test)):
        if Senses_Split_test[i] in ['HARD2', 'HARD3', 'cord', 'formation', 'phone', 'text', 'division', 'interest1', 'interest2', 'interest3', 'interest4', 'interest5']:
