...
feval = function(x_new)
    ...
    if sgd_params.evalCounter%10 == 0 then
        ...
        --wordIds, probabilities = model:eval(encoderInputs:select(2,test_from_batch_index),checkword,Secab,Index2Secab,SecabSize)
        --str_sent=""
        ...
        --for _tmp, ind in ipairs(wordIds) do 
            ...
            --else
                --expected_output = Index2Secab[decoderTargets[tmp][test_from_batch_index]]
                --str_sent_target = str_sent_target .. " " .. expected_output
            --end

            
            --if expected_output == Index2Secab[ind[1]] then
                --tmp_err = tmp_err + 1
            --end
        ...
        --for i =1,(#decoderTargets)[1] do
            --if decoderTargets[i][test_from_batch_index] ~= 0 then
                --expected_output = Index2Secab[decoderTargets[i][test_from_batch_index]]
                --str_sent_target = str_sent_target .. " " .. expected_output
            --end
        --end
...
model = Seq2Seq(VocabSize,SecabSize,hiddenSize,hiddenSize2)
...
for j=1,10000 do
    ...
    for i = 1, numDocuments/batchSize do	
        ...
        --print('==========================================================')
        --print("Accuracy after "..j.." Epochs")
        --eval(model,Vocab,Secab,Index2Vocab,Index2Secab)
        --os.execute("python quantify_results.py Accuracy =")
        --print('==========================================================')
